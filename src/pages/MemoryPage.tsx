        ...
        <div className="max-w-full mx-auto p-4 space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="xs" icon={Filter} className="text-primary-500 hover:underline">
                  筛选
                </Button>
                <Button variant="ghost" size="xs" icon={RefreshCw} className="text-primary-500 hover:underline">
                  刷新
                </Button>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-2 group-hover:translate-y-0">
                      <Button variant="icon" icon={ArrowUpRight} className="bg-white dark:bg-[#2a2a2c] text-primary-500 shadow-lg hover:scale-110" />
                    </div>
                  </div>
                );
              })}
